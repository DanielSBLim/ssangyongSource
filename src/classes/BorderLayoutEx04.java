...
public class BorderLayoutEx04 {
	...
	public static void main(String[] args) {	
		...
		obj.btnEast.setBackground(Color.blue);
		obj.btnWest.setBackground(Color.GREEN);
		obj.btnNorth.setBackground(Color.RED);
		obj.btnSouth.setBackground(Color.gray);
		obj.btnCenter.setBackground(Color.ORANGE);
