...
public class MemInsMunni01 extends WindowAdapter implements WindowListener {
   ...
   // South 내역
   static JButton bntMaxDown = new JButton("★☆★☆★☆★☆★☆");
   // ----------------------------------------------------------------------------------------------------------------
   ...
   // 상반
   static JButton titleButton = new JButton("한국 ICT 개발자 과정");
   static JButton titleApplicate = new JButton("회원가입");

   // 중간
   static String[] subTitle = { "ID", "PW", "회원명", "E-mail", "Phone", "주소" };
   static JTextField[] calText = new JTextField[6];
   static JButton[] btnlist = new JButton[6];
   ...
   public static void main(String[] args) {
      ...
      MemInsMunni01 obj = new MemInsMunni01();
...
//        panelArrayGrid 세팅하기.
      ...
      for (int i = 0; i < 6; i++) {
         ...
         btnlist[i] = new JButton(subTitle[i]);
