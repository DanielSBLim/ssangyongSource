...
public class FontEx01 extends WindowAdapter implements WindowListener {
	...
	public static void main(String[] args) {
		...
		bntArraySettingNorth(panel1, btn, colorArray, msg);
		bntArrySettingSouth(panel2, btn2, colorArray, msg);
	...
	public static void bntArraySettingNorth(Panel panel1, Button[] btn, Color[] colorArray, String[] getMsg) {
