...
public class StudentMain2 {
	...
	public static void main(String[] args) {
		...
		ArrayList<StudentDTO> dtoL;
		StudentDAO2 obj2 = new StudentDAO2();
		dtoL = (ArrayList)(obj2.studentInfo());
		
	
		
		System.out.println(dtoL.get(1).getVName());
		...
		for (int peopleCount = 0; peopleCount < dtoL.size(); peopleCount++) {
			...
			System.out.printf("%s %d %d %d %.2f \n", dtoL.get(peopleCount).getVName(), dtoL.get(peopleCount).getVKor(),
