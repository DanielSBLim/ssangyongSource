...
public class MemInsMunnisu extends WindowAdapter implements WindowListener {
   ...
   public static void main(String[] args) {
      ...
      MemInsMunnisu obj = new MemInsMunnisu();
...
//        panelArrayGrid 세팅하기.
      ...
      titleLabel.setIcon(new ImageIcon("./client/int.jpg"));
   ...
   public static void panelBorderCenterSetting(JPanel getJPanel) {
      ...
      labelMaxDown.setBackground(Color.WHITE);
