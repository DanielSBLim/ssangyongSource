...
public class MemDelMunnisu extends WindowAdapter implements WindowListener {

	// 프레임설정
	// panelBorderCenter 센터
	static JFrame frameObj = new JFrame("회원탈퇴");
	...
	// 상반
	static JLabel titleButton = new JLabel("회원탈퇴");
	...
	static JButton ApplicateDown = new JButton("회원탈퇴");
	...
	public static void main(String[] args) {
		...
		MemDelMunnisu obj = new MemDelMunnisu();
