...
public class MemUpdMunnisu02 extends JPanel implements WindowListener {
	...
	// South 내역
	JPanel panelBorderSouth = new JPanel(new BorderLayout());
	...
	// 상반
	JLabel titleButton = new JLabel("회원수정");
	...
	JButton ApplicateDown = new JButton("회원수정");
	JButton DeApplicateDown = new JButton("초기화");
	// ----------------------------------------------------------------------------------------------------------------
