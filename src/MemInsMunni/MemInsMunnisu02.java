...
public class MemInsMunnisu02 extends JPanel implements WindowListener {

   // 프레임설정
   // panelBorderCenter 센터
    JFrame frameObj = new JFrame("회원가입");
   ...
   // 상반
    JLabel titleLabel = new JLabel("Aplication");
    JLabel titleApplicate = new JLabel("회원가입");
   ...
   // 하반
    ...
    JButton btnApplicateDown = new JButton("회원가입");
